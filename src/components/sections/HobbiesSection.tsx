          ...
          <div className="card bg-base-200">
            <div className="card-body">
              ...
              <ul className="space-y-2 mt-4">
                ...
                <li className="flex items-start gap-2"><span className="text-info">📝</span><span>{t('hobbies.writing.blog')}</span></li>
                <li className="flex items-start gap-2"><span className="text-info">📚</span><span>{t('hobbies.writing.editor')}</span></li>
                <li className="flex items-start gap-2"><span className="text-warning">🔥</span><a href="https://labs.gree.jp/blog/2011/04/3282/" target="_blank" rel="noopener noreferrer" className="link link-primary hover:link-accent">{t('hobbies.writing.gree')}</a></li>
              </ul>
            </div>
          </div>
          <div className="card bg-base-200">
