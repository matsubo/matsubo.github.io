...
const HeroSection = () => (
  <section className="py-16 px-4 bg-gradient-to-br from-base-200 to-base-300" aria-labelledby="hero-heading">
    <div className="max-w-6xl mx-auto text-center">
      ...
      <h1 id="hero-heading" className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
        Yuki Matsukura
      </h1>
      ...
      {/* Social Links */}
      <nav className="flex flex-wrap justify-center gap-3 mt-8" aria-label="Social media links">
        <a
        ...
        <a
          ...
          aria-label="Visit my Zenn articles"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
