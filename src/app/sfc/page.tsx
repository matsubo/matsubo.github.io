      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <Link
              href="/sfc/documents/time_table_2001_9"
            ...
            <Link
              href="/sfc/documents/time_table_2002_4"
              className="card bg-base-100 shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
              <div className="card-body">
            ...
            <Link
              href="/sfc/documents/time_table_2002_9"
              className="card bg-base-100 shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
              <div className="card-body">
            ...
            <Link
              href="/sfc/documents/time_table_2003_4"
              className="card bg-base-100 shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
              <div className="card-body">
            ...
            <Link
              href="/sfc/documents/time_table_2003_9"
              className="card bg-base-100 shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
              <div className="card-body">
                <h3 className="card-title">3年秋学期</h3>
                <p className="text-sm opacity-70">2003年秋</p>
              </div>
            </Link>
            <Link
              href="/sfc/documents/time_table_2004_4"
              className="card bg-base-100 shadow-lg hover:shadow-xl transition-all hover:scale-105"
            >
              <div className="card-body">
                <h3 className="card-title">4年春学期</h3>
          ...
          <div className="space-y-6">
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <a href="/archive/sfc/documents/neural/neural.lzh" className="btn btn-sm btn-outline">
                    <CodeBracketIcon className="h-4 w-4 mr-1" />
                    プログラム (lzh)
                  </a>
                  <a href="/archive/sfc/documents/neural/20030116_00.doc" className="btn btn-sm btn-outline">
                    <DocumentTextIcon className="h-4 w-4 mr-1" />
                    レポート (doc)
                  </a>
                  <a href="/archive/sfc/documents/neural/neural_final_presentation.ppt" className="btn btn-sm btn-outline">
                    <DocumentTextIcon className="h-4 w-4 mr-1" />
                    プレゼン (ppt)
                  </a>
                </div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <a href="/archive/sfc/documents/guide/2002.zip" className="btn btn-sm btn-outline">
                    <FolderIcon className="h-4 w-4 mr-1" />
                    2002年仕様書
                  </a>
                  <a href="/archive/sfc/documents/guide/2003.zip" className="btn btn-sm btn-outline">
                    <FolderIcon className="h-4 w-4 mr-1" />
                    2003年仕様書
                  </a>
                </div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <Link href="/sfc/mule" className="btn btn-sm btn-outline">
                    <DocumentTextIcon className="h-4 w-4 mr-1" />
                    muleコマンドリファレンス
                  </Link>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                ...
                <Link href="/sfc/pro/" className="link link-primary">
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                ...
                <Link href="/sfc/binbou/" className="link link-primary">
